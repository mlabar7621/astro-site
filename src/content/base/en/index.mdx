...
<div class="row-block" id="row-1">
    ...
    <div class="float-right"> 
        <img class="hero-image" src="/img/base/silicon-wafer.png" />
    </div>
</div>
<div class="row-block" id="row-2">
    ...
    <div class="float-right"> 
        <img class="hero-image" src="/img/base/prague.png" />
    </div>
</div>
<div class="row-block" id="row-3">
    ...
    <div class="float-right"> 
        <img class="hero-image" src="/img/base/speech.png" />
    </div>
</div>
<div class="row-block" id="row-4">
    ...
    <div class="float-right"> 
        <img class="hero-image" src="/img/base/greenhouse.png" />
    </div>
</div>